...
const routers = [
    ...
    {
        path: '/docs/guide/vued-loader',
        meta: {
            title: 'Vued Loader'
        },
        component: (resolve) => require(['./views/guide/vued-loader.vue'], resolve)
    },
    {
        path: '/docs/guide/vued-loader-en',
        meta: {
            title: 'Vued Loader'
        },
        component: (resolve) => require(['./views/guide/vued-loader-en.vue'], resolve)
    },
    {
