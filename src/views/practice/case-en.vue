...
<template>
    <i-article>
        <article>
            ...
            <p>Vued is a set of front-end solutions developed by <a href="https://www.talkingdata.com/" target="_blank">TalkingData</a> for intermediate and backend business, including engineering, theme customization, multi-language and other functions, greatly improving the development efficiency.</p>
            <p>Since late 2016, Vued has been used in many new projects of TalkingData, and even gradually used in refactoring of some core projects.</p>
            <p>Vued has gradually become the design and development specification for TalkingData.</p>
            <Anchor title="The Best Case" h2></Anchor>
            <Anchor title="App Analytics" h3></Anchor>
            <Row :gutter="32">
                <i-col span="10">
                    <p>App analytics is the core product of TalkingData. Due to historical reasons, the project has been precipitated for a long time. Compared with the traditional development model of the previous version, AppAnalytics has fully been refactored based on Vued, and its visual effects and interaction has been greatly improved.</p>
