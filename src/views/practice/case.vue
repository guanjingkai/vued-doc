...
<template>
    <i-article>
        <article>
            <h1>实践案例</h1>
            <p>Vued 是由 <a href="https://www.talkingdata.com/" target="_blank">TalkingData</a> 开发的，面向中后台业务的一整套前端解决方案，包含了工程构建、主题定制、多语言等功能，极大提升了开发效率。</p>
            <p>从 2016 年下旬开始，TalkingData 的众多新项目开始使用 Vued，部分核心项目已逐步开始使用 Vued 重构。</p>
            <p>Vued 已逐步成为 TalkingData 的设计和开发规范。</p>
            <Anchor title="最佳实践" h2></Anchor>
            <Anchor title="App 统计分析" h3></Anchor>
            <Row :gutter="32">
                <i-col span="10">
                    <p>App 统计分析是 TalkingData 最核心的产品，因历史原因，项目已沉淀很久，开发模式也比较传统，现已全面基于 Vued 进行重构，视觉和交互都有极大的提升。</p>
