...
<template>
    <i-article>
        <article>
            ...
            <p>Vued recommends to use the colors of the palette below as the rule for design and development for ensuring the visual consistence among the pages and components.</p>
            <Anchor title="Primary Colors" h3></Anchor>
            <p>Vued use the safe blue colors as the primary colors, among which the <strong>Light Primary</strong> is usually used for <i>hover</i> state while the <strong>Dark Primary</strong> for <i>active</i>.</p>
            <Row :gutter="16">
                <i-col span="8">
