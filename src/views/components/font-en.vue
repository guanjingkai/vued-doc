...
<template>
    <i-article>
        <article>
            ...
            <p>Vued's stylesheet has already standardized the typography for achieving the most appealing display effects regardless of the OS and browers. The fonts of the <Icon type="social-apple"></Icon> macOS（iOS）are used whenever they're available, the fallback ones are also provided.</p>
