...
<template>
    <i-article>
        <article>
            ...
            <blockquote style="color: #ed3f14">Warning: If you don't use <router-link to="/docs/guide/vued-loader-en">vued-loader</router-link>, you have to use <code>i-circle</code> tag.</blockquote>
