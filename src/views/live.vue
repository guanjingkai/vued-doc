...
<template>
    <i-article>
        <article style="min-height: 500px">
            <h1>Vued 讲堂</h1>
            <p>Vued 讲堂以技术分享为目的，不定期地以直播或录制视频的形式开展。</p>
        ...
        data () {
            return {
                list: [
                    ...
                    {
                        title: '基于 Vue.js 2.x 的 Vued 组件开发实践',
                        time: 'finish',
                        cost: '6.6元',
                        cover: 'https://ooo.0o0.ooo/2017/03/16/58c96bdc984ec.jpeg',
                        desc: 'Vued 2.0 版本发布了测试版，已全面支持 Vue.js 2.x。直播主要介绍 Vued 2.0 的组件开发实践。主要内容为：升级 2.0 经验分享；部分组件设计思路；Q & A',
