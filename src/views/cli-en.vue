            ...
            <Row type="flex" justify="center" align="middle">
                <i-col span="12">
                    <div class="cli-info">
                        ...
                        <p class="cli-info-title">Vued Cli</p>
                        <div class="cli-info-desc">Create Vued project with a visual way.</div>
    ...
    export default {
        ...
        methods: {
            ...
            handleClick (type, bit) {
                if (type === 'mac') {
                    window.open('http://git.oschina.net/icarusion/vuedcli/raw/master/Vued-cli-2.0.0.dmg');
                } else if (type === 'windows') {
                    if (bit === 64) {
                        window.open('http://git.oschina.net/icarusion/vuedcli/raw/master/Vued-cli-2.0.0-win32-x64.zip');
                    } else if (bit === 32) {
                        window.open('http://git.oschina.net/icarusion/vuedcli/raw/master/Vued-cli-2.0.0-win32-ia32.zip');
                    }
                } else if (type === 'linux') {
                    if (bit === 64) {
                        window.open('http://git.oschina.net/icarusion/vuedcli/raw/master/Vued-cli-2.0.0-linux-x64.zip');
                    } else if (bit === 32) {
                        window.open('http://git.oschina.net/icarusion/vuedcli/raw/master/Vued-cli-2.0.0-linux-ia32.zip');
                    }
                } else if (type === 'github') {
                    window.open('https://github.com/guanjingkai/vued-cli');
                }
            }
        },
        mounted () {
