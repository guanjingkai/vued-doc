<template>
    <i-article>
        <article>
            ...
            <p>Get the latest version of Vued from <a href="https://unpkg.com/vued/" target="_blank">unpkg.com/vued</a>. Use CDN to deliver compiled JS and CSS to your project:</p>
            ...
            <p>Install Vued with the node package manager. It can work with webpack and ES2015 very well.</p>
