        ...
        <article class="doc-update">
            <Timeline pending>
                ...
                <Timeline-item>
                    ...
                    <ul>
                        <li>发布 <router-link to="/docs/guide/vued-loader">vued-loader</router-link>。</li>
                ...
                <Timeline-item color="green">
                    ...
                    <ul>
                        ...
                        <li>修复 Table 在数据为空，设置表格高度时，添加数据后，表格高度计算不正确的bug。<a href="https://github.com/guanjingkai/vued/commit/119eeafedea02d984650b82920abdcdf4e809f79" target="_blank">commit</a></li>
                        <li>
                ...
                <Timeline-item>
                    ...
                    <ul>
                        <li>修复部分组件在非 template 内书写时不被识别的问题。部分组件新增别名，并兼任1.0版别名。
                            详见 <a href="https://github.com/guanjingkai/vued/blob/2.0/src/index.js#L49" target="_blank">https://github.com/guanjingkai/vued/blob/2.0/src/index.js#L49</a></li>
                    </ul>
                </Timeline-item>
                <Timeline-item color="green">
                    <Icon type="trophy" size="18" slot="dot"></Icon>
...
<script>
    ...
    export default {
        ...
        methods: {
            handleBefore () {
                window.open('http://vued.design/docs/guide/update');
            }
        }
    }
</script>