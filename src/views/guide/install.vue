<template>
    <i-article>
        <article>
            ...
            <p>通过 <a href="https://unpkg.com/vued/" target="_blank">unpkg.com/vued</a> 可以看到 Vued 最新版本的资源，也可以切换版本选择需要的资源，在页面上引入 js 和 css 文件即可开始使用：</p>
            <i-code lang="html" bg>{{ code.install.cdn }}</i-code>
            <Anchor title="示例" h3></Anchor>
            <p>通过 CDN 可以快速使用 Vued 写出一个示例，您可以复制下面代码或<a href="http://output.jsbin.com/libihed" target="_blank">在线预览</a>。</p>
