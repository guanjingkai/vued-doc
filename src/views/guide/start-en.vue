<template>
    <i-article>
        <article>
            ...
            <p>Before using Vued, we encourage you to read guide of Vue.js first.</p>
            <ul>
                <li>
            ...
            <Anchor title="Vued CLI (Recommend)" h2></Anchor>
            <p>Vued provide an <router-link to="/cli">CLI</router-link> for quickly construct a project with Vued.</p>
            <Anchor title="Starter Kit" h2></Anchor>
            <p>We provide a starter kit <a href="https://github.com/guanjingkai/vued-project" target="_blank">vued-project</a> for you.</p>
            ...
            <Anchor title="Import Vued" h2></Anchor>
            <p>Import Vued in the entry file (<code>main.js</code> as usual) of webpack:</p>
            ...
            <ul>
                <li>Partial import will only effect logic level; you still need to import all the styles, which means add <code>import 'vued/dist/styles/vued.css';</code> to <strong>main.js</strong> or the root component.</li>
            ...
            <p>The following components, you must add a prefix <code>i-</code>, unless you use <router-link to="/docs/guide/vued-loader-en">vued-loader</router-link>:</p>
            <ul>
