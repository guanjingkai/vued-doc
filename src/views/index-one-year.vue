                ...
                <i-col span="24">
                    ...
                    <div class="list">
                        <div class="list-a">
                            ...
                            <a href="https://github.com/guanjingkai/vued" target="_blank">
                        ...
                        <div style="text-align: center;padding-top: 12px;">
                            <a style="text-decoration: underline" href="https://zhuanlan.zhihu.com/p/28090879" target="_blank">阅读 Vued 一周年专题文章</a>
                        </div>
                        <!--<div class="index-card">-->
                            <!--<Tooltip content="阅读 Vued 一周年专题文章">-->
...
<script>
    ...
    const apiPath = 'https://vued.design';
//    const apiPath = 'http://127.0.0.1:9800';
    ...
    export default {
        ...
        computed: {
            ...
            placeholder () {
                if (this.lang === 'zh-CN') {
                    let msg = 'Vued 一周年啦，发条弹幕乐呵乐呵吧！';
                    if (this.counter !== 0 ) {
                        msg += '（等待' + this.counter + '秒）'
                    }
                    return msg;
                } else {
                    return 'Send a barrage to celebrate Vued one years old.';
                }
            }
        },
        methods: {
