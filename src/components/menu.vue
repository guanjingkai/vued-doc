        ...
        methods: {
            ...
            handleSelect (type) {
                ...
                if (type === 'donate') {
                    ...
                    window.open('https://github.com/guanjingkai/vued');
                } else if (type === 'guide') {
                ...
                } else if (type === 'vued-loader') {
                    this.$router.push('/docs/guide/vued-loader' + pathSuffix);
                }
                this.$nextTick(() => {
            ...
            handleVersion (v) {
                if (v == 1) {
                    window.location.href = 'http://vued.design';
                }
            },
            handleGoToGitHub () {
                window.open('https://github.com/guanjingkai/vued');
