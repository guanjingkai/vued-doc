...
<template>
    <div>
            ...
            <div class="footer-main">
                <Row>
                    <i-col span="5">
                        ...
                        <ul>
                            <li>
                                <a href="https://github.com/guanjingkai/vued" target="_blank">Vued</a>
                            </li>
                            <li>
                                <a href="https://github.com/guanjingkai/vued-cli" target="_blank">Vued Cli</a>
                            </li>
                            <li>
                                <a href="https://github.com/guanjingkai/vued-doc" target="_blank">Vued Doc</a>
                            </li>
                            <li>
                                <a href="https://github.com/guanjingkai/vued-project" target="_blank">Vued Project</a>
                            </li>
                            <li>
                                <a href="https://github.com/guanjingkai/vued-theme" target="_blank">Vued Theme</a>
                            </li>
                        </ul>
                    </i-col>
                    <i-col span="5">
                    ...
                    <i-col span="5" offset="2">
                        ...
                        <ul>
                            <li>
                                <a href="https://github.com/guanjingkai/vued/issues" target="_blank">{{ $t('index.feedback') }}</a>
                            </li>
                            <li>
                                <a href="https://github.com/guanjingkai/vued/issues/new" target="_blank">{{ $t('index.bug') }}</a>
                            </li>
                            <li>
                                <a href="https://gitter.im/vued/vued" target="_blank">{{ $t('index.chat') }}</a>
                            </li>
                            <li>
                                <a href="https://segmentfault.com/t/vued" target="_blank">SegmentFault</a>
                            </li>
                        </ul>
                    </i-col>
                    <i-col span="5" offset="2">
        ...
        <Modal v-model="donate" v-if="lang === 'zh-CN'" title="支持 Vued 的开发" @on-ok="handleModalClose" @on-cancel="handleModalClose" class-name="vertical-center-modal">
            <div class="ivu-article">
                <p>Vued 是采用 MIT 许可的开源项目，您可以在个人或企业项目中免费使用。不过，如果您觉得 Vued 对您的项目带来了帮助，提高开发效率，可以用捐助来表示您的谢意：)</p>
        ...
        <Modal v-model="donate" v-if="lang !== 'zh-CN'" title="Donate Vued project" @on-ok="handleModalClose" @on-cancel="handleModalClose" class-name="vertical-center-modal">
            <div class="ivu-article">
                <p>Vued is an open source project with MIT licenses that you can use for free in your personal or business projects. However, if you feel that Vued has helped your project to improve development efficiency, you can use donations to express your gratitude: )</p>
        ...
        <Modal v-model="ask" title="提问" @on-ok="handleModalClose" @on-cancel="handleModalClose" :styles="{top: '20px'}">
            <div class="ivu-article">
                <p>如果您在开发中遇到问题，包括但不限于 Vued、JavaScript、Vue、Webpack 等相关技术，可以加入小密圈和我们一对一提问，收到问题后，我们会在 30 分钟内解答。</p>
                <p>因为提供高质量的答疑服务，所以我们暂时收费 <span style="color: #f50">￥98/年</span> 。</p>
                <p>如果您不愿意付费，可以在 GitHub 提交与 Vued 相关的 issues，或到 <a href="https://segmentfault.com/t/iview" target="_blank">社区</a>讨论。</p>
                <div>
        ...
        methods: {
            ...
            updateActiveNav () {
                const componentList = [
                    ...
                    '/docs/guide/theme',
                    '/docs/guide/theme-en',
                    '/docs/guide/vued-loader',
                    '/docs/guide/vued-loader-en',
                    '/overview',
                    '/overview-en',
                    '/docs/guide/update',
