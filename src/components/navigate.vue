...
<template>
    <div class="navigate">
        ...
        <Modal v-model="showAd" title="Recruiting Translation Volunteer">
            <div class="i-article">
                <p style="font-size: 16px;">Vued team are recruting volunteers to help us translate the document. If you master both Chinese and English, we are looking forward to your joining in our translation plan and help us improve Vued. If you want to join in the translation plan, please send E-Mail to <a href="mailto:admin@aresn.com">admin@aresn.com</a></p>
            </div>
        </Modal>
    </div>
</template>
...
//                this.showAd = true;
                window.open('https://vued.design/vue-book');
            }
        },
        created () {
            this.lang = this.$lang;
